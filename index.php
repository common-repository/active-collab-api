...
class ActiveCollabAPI{
	...
	function __construct(){
		...
		add_action( 'wp_ajax_nopriv_a_registerTime', array($this,'a_registerTime')); //insert log record
		add_action( 'wp_ajax_a_registerTime', array($this,'a_registerTime'));//insert log record
    			...
    			<div id="subtask-add" class="collapse">
    				<form id="addSubTask" method="post">
    					<div class="form-group">
							...
							<input type="text" class="form-control control" name="addSubTaskName" id="addSubTaskName" placeholder="Name of the subtask" required maxlength="50" minlength="1">
    					</div>
    					<div class="form-group">
			...
			<div class="time-task">
    			...
    			<div id="time-tasklist" class="collapse">
    				<form id="timeLogTaskById" method="post">
    					<div class="form-group">
    						<label for="timeLogRecord">Time Log Hrs (<span class="required-field">*</span>)</label>
